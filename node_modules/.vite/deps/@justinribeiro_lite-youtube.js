...
var LiteYTEmbed = class _LiteYTEmbed extends HTMLElement {
  ...
  connectedCallback() {
    this.addEventListener("pointerover", () => _LiteYTEmbed.warmConnections(this), {
      once: true
    });
  ...
  async testPosterImage() {
    setTimeout(() => {
      ...
      img.onload = async (e) => {
        ...
        const noPoster = (target == null ? void 0 : target.naturalHeight) == 90 && (target == null ? void 0 : target.naturalWidth) == 120;
        if (noPoster) {
    ...
    const observer = new IntersectionObserver((entries, observer2) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting && !this.isIframeLoaded) {
          _LiteYTEmbed.warmConnections(this);
          this.addIframe(true);
...
//# sourceMappingURL=@justinribeiro_lite-youtube.js.map
